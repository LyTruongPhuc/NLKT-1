...
- Thực hiện kiểm thử giao diện người dùng (UI Testing)
...
- Thiết bị: Macbook
- Hệ điều hành: MacOS
- Trình duyệt: Google Chrome (đã đăng nhập tài khoản cá nhân)
- Thời gian kiểm thử: 21h-11/1/2026
...
3. Thực hiện lựa chọn các khối màu khác biệt
...
- Giao diện đơn giản nhưng yêu cầu khả năng phân biệt màu tốt
